...
export default function RegisterProScreen({ navigation }: any) {
  // Estados para capturar os inputs do Profissional
  ...
  const handleRegisterPro = async () => {
    if (!nome || !email || !categoria || !regiao || !senha) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {/* Header com a Logo e Título idênticos à imagem */}
        ...
        <View style={styles.form}>
          ...
          {/* Botão de envio com o texto "Entrar" igual ao da imagem */}
          <TouchableOpacity style={styles.button} onPress={handleRegisterPro}>
